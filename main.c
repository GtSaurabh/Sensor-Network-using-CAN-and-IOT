...
//
//        // Convert the ADC value to voltage (assuming a 3.3V reference voltage)
//         voltage = (adcValue / 4095.0) * 5;
//
//        return voltage;
//    }
//
//    // Return an invalid voltage value if conversion fails
//    return -1.0;
//}
//
//
//int CheckSmokeAndControlLED(void)
//{
//    float voltage = ReadADCValue();
//    int state = 0;
//
//        // Smoke detection logic (adjust the threshold as needed)
//        if (voltage > 2.1)
//        {
//            // Smoke detected, turn on onboard LED (PD12)
//            HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET);
//            state = 1;
//        }
//        else
//        {
//            // No smoke detected, turn off onboard LED (PD12)
//            HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_RESET);
//            state = 0;
//        }
//
